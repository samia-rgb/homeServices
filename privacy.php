        ...
        <section class="content-central">
            ...
            <div class="content_info">
                <div class="skin_base paddings-mini color-white text-center">
                    <h2>Need Help? Call our Expert 24 X 7 - 01403692054</h2>
                </div>
            </div>            
        </section>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:01403692054">01403692054</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Bashundara, Mirpur, Dhaka</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">contact@surfsidemedia.in</a>
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:01403692054">+91-1234567890</a>
                            </li>
                        </ul>
